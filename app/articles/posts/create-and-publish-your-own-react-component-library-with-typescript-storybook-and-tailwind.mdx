...
summary: 'Guide on how to publish your own custom React component library with Storybook, TypeScript, and Tailwind to NPM.'
---
...
#### Step I: Initialize project using tsdx

```bash
npx tsdx create playground
```

This will promp you to choose from three different options, `basic`, `react`, and `react-with-storybook`.

Please choose `react-with-storybook`

![create-playground](/static/blog/create-playground.webp)

#### Step II: Adding Tailwind
...
#### Step III: Setup our build configuration
...
package name to whatever we want, in our case it is called `@subash/playground`

```json
"name": "@subash/playground",
...
Boom, you are done! you can now check our NPM account for our new package [@subash/playground](https://www.npmjs.com/package/@subash/playground).
