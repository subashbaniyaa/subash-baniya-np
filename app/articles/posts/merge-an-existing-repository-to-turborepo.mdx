...
summary: 'Guide on how to merge any existing app or library into Turborepo.'
---
...
I won't be explaining what a monorepo is in this article, but if you are interested in learning more about it, I have made a similar article on [how to merge a git repository into Nx](/articles/how-to-merge-a-repository-into-nx).

### Step I: Clone the source repository
...
### Step II: Filter the source repository into its own subdirectory
...
### Step III: Push the Filtered Repo to the Monorepo
