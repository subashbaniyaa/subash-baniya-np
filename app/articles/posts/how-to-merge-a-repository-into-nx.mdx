...
summary: 'Guide on how to merge any existing app or library into a Nx monorepo.'
---
...
### Step I: Clone source repository
...
### Step II: Move all files into the right sub directory.
...
### Step III: Add remote in your monorepo to packageC
...
### Step IV: Merge packageC into monorepo
